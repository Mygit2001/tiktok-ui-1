         ...
         <div className={cx('inner')}>
            <div>
               <Link to={config.routes.home} className={cx('logo-head')}>
                  <img src="https://site-images.similarcdn.com/image?url=music.yandex.ru&t=2&s=1&h=bdb9daf0cb6126ac696bc6ae6a56559b1ac0d1f97b60bd3926626bd553f51b40" alt="logo tiktok" />
               </Link>
            </div>
            {<Search />}
