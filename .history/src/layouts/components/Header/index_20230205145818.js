         ...
         <div className={cx('inner')}>
            <div>
               <Link to={config.routes.home} className={cx('logo-head')}>
                  <img src= "https://site-images.similarcdn.com/image?url=discogs.com&t=2&s=1&h=c6bf2cb30ff0ccba1331a88416e78887c0a99ee61cba27e25eb83427d75dd8ad" alt="logo tiktok" />
               </Link>
            </div>
            {<Search />}
